...
namespace c
{
	...
	inline ImVec4 accent = ImColor(0, 247, 255);

	namespace bg
	{
		inline ImVec4 background = ImColor(12, 18, 20);
		inline ImVec4 shadow = ImColor(0, 0, 0, 40);
		inline ImVec4 border = ImColor(12, 18, 20, 255);
		inline ImVec2 size = ImVec2(810, 540);
		inline ImVec2 size2 = ImVec2(360, 460);
		inline float rounding = 4.f;
	}

	namespace child
	{
		inline ImVec4 background = ImColor(29, 30, 31);
